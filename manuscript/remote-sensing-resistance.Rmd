...
Resilience of ecological systems is fundamentally challenging to quantify

A key feature of resilience is resistance-- how easy it is to change the system state [@Walker2004]. While resistance doesn't fully capture the notion of resilience, it does provide an avenue for measuring some component 

Idea of moving from metaphors to measurements
...
We found that the remotely sensed RBR metric of wildfire severity measured across a 48 day interval prior to the wildfire alarm date correlated best with ground based composite burn index (CBI) measurements of severity. 
...
1. The relative importance of heterogeneity depends on fire weather conditions (fuel moisture).
    a. Greater heterogeneity reduces wildfire severity under non-extreme fuel moisture conditions.
    b. Greater heterogeneity increases wildfire severity under extreme fuel moisture conditions. 
