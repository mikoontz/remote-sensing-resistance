...
params:
  ...
  affiliation: |
    ...
    ^4^Pacific Southwest Research Station, U.S.D.A. Forest Service; Mammoth Lakes, CA, USA  
    ...
    ^7^U.S. Geological Survey, Southwest Biological Science Center  
    ^8^Department of Ecology and Evolutionary Biology, University of Colorado; Boulder, CO, USA  
  keywords: |
    resilience, wildfire, severity, texture analysis, forest structure
  correspondence: |
